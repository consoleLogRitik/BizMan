...
const Home = () => {
  return (
    <div className="bg-gray-100">
      ...
      {/* Hero Section */}
      <div className="flex flex-col text-center items-center justify-center h-screen text-gray-600">
        <h1 className="text-6xl font-extrabold mb-6">Welcome to <span className="text-lime-500 hover:animate-pulse">BizMan</span></h1>
        ...
        <Link to='/signup'><button className="bg-lime-600 shadow-2xl text-white px-6 py-3 rounded-lg hover:animate-pulse">Get Started </button></Link>
        
      </div>

      {/* Features Section */}
      <section id="features" className="container mx-4 py-4">
      ...
      {/* Benefits Section */}
      <section id="benefits" className="bg-gray- py-20">
        <div className="container mx-auto text-center">
          ...
          <ul className="mt-6 space-y-2">
            <li className="animate-pulse text-gray-700">✔️ User-friendly interface</li>
            <li className="animate-pulse text-gray-700">✔️ 24/7 Customer Support</li>
            <li className="animate-pulse text-gray-700">✔️ Scalable solutions for businesses of all sizes</li>
          </ul>
        </div>
      </section>

      {/* Testimonials Section */}
      <section id="testimonials" className="container mx-auto py-8">
